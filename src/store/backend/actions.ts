...
import CreatePostMutation from '@/api/mutations/CreatePostMutation.graphql';import UploadPostImageMutation from '@/api/mutations/UploadPostImageMutation.graphql';
